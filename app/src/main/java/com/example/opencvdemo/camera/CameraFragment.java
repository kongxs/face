...
import com.example.opencvdemo.MainActivity;
...
//                bp = BitmapFactory.decodeByteArray(bytes,0,bytes.length);
    ...
    private class detectAsync extends AsyncTask<Bitmap, Void, VisionDetRet[]> {
        ...
        protected VisionDetRet[] doInBackground(Bitmap... bp) {
            ...
            Bitmap param = bp[0];
//            Bitmap result = MainActivity.Bitmap2Grey(param);
